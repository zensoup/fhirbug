...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/DiagnosticReport) on 2017-10-28.
...
class DiagnosticReportImage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DiagnosticReportImage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DiagnosticReportPerformer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DiagnosticReportPerformer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
