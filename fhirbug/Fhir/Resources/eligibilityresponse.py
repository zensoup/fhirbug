...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/EligibilityResponse) on 2019-01-25.
...
class EligibilityResponse(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(EligibilityResponse, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class EligibilityResponseError(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(EligibilityResponseError, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class EligibilityResponseInsurance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(EligibilityResponseInsurance, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class EligibilityResponseInsuranceBenefitBalance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(EligibilityResponseInsuranceBenefitBalance, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class EligibilityResponseInsuranceBenefitBalanceFinancial(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(EligibilityResponseInsuranceBenefitBalanceFinancial, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
