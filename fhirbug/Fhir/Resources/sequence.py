...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Sequence) on 2019-01-25.
...
class Sequence(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Sequence, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SequenceQuality(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SequenceQuality, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SequenceReferenceSeq(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SequenceReferenceSeq, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SequenceRepository(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SequenceRepository, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SequenceVariant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SequenceVariant, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
