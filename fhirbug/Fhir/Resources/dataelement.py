...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/DataElement) on 2019-01-25.
...
class DataElement(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DataElement, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DataElementMapping(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DataElementMapping, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
