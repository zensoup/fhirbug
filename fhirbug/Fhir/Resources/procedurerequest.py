...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/ProcedureRequest) on 2019-01-25.
...
class ProcedureRequest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcedureRequest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ProcedureRequestRequester(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcedureRequestRequester, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
