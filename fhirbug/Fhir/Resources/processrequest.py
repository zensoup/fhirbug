...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/ProcessRequest) on 2019-01-25.
...
class ProcessRequest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcessRequest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ProcessRequestItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcessRequestItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
