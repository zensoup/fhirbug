...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Device) on 2017-10-28.
...
class DeviceUdi(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceUdi, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
