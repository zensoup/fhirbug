...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/DeviceComponent) on 2019-01-25.
...
class DeviceComponent(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceComponent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceComponentProductionSpecification(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceComponentProductionSpecification, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
