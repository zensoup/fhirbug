...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/ReferralRequest) on 2019-01-25.
...
class ReferralRequest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ReferralRequest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ReferralRequestRequester(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ReferralRequestRequester, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
