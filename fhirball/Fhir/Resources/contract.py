...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Contract) on 2017-10-28.
...
class ContractAgent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ContractAgent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ContractTermAgent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ContractTermAgent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ContractTermValuedItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ContractTermValuedItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ContractValuedItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ContractValuedItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
