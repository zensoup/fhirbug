...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Medication) on 2017-10-28.
...
class MedicationPackage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationPackage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicationPackageBatch(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationPackageBatch, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicationPackageContent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationPackageContent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
