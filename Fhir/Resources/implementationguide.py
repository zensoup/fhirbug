...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2017-10-28.
...
class ImplementationGuideDependency(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDependency, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuidePackage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuidePackage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuidePackageResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuidePackageResource, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuidePage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuidePage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
