...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Task) on 2017-10-28.
...
class TaskRequester(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(TaskRequester, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
