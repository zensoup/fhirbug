...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Coverage) on 2017-10-28.
...
class CoverageGrouping(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageGrouping, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
