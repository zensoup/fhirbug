...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Immunization) on 2017-10-28.
...
class ImmunizationExplanation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImmunizationExplanation, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImmunizationPractitioner(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImmunizationPractitioner, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImmunizationVaccinationProtocol(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImmunizationVaccinationProtocol, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
