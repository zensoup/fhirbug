...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/ImagingManifest) on 2017-10-28.
...
class ImagingManifest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImagingManifest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImagingManifestStudy(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImagingManifestStudy, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImagingManifestStudySeries(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImagingManifestStudySeries, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImagingManifestStudySeriesInstance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImagingManifestStudySeriesInstance, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
