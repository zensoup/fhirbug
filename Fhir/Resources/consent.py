...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.1.11917 (http://hl7.org/fhir/StructureDefinition/Consent) on 2017-10-28.
...
class ConsentActor(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConsentActor, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConsentData(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConsentData, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConsentExcept(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConsentExcept, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConsentExceptActor(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConsentExceptActor, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConsentExceptData(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConsentExceptData, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
